...
//    int num=7;
//    char *arg[7]={"\0","classifier","predict","cfg/imagenet.data","cfg/darknet_iden.cfg","backup/darknet_iden.backup","data/eagle.jpg"};
//    run_classifier(7, arg);
//    int num=5;
//    char *arg[5]={"\0","classifier","train","cfg/imagenet.data","cfg/darknet_iden.cfg"};
//    run_classifier(5, arg);
    if(argc < 2){
